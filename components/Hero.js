  ...
  return (
    <div className=" w-full h-screen text-center ">
      <div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center">
        <div>
          <p className="uppercase text-sm tracking-widest border-b-2 shadow-b py-5 text-gray-400 ">
          ...
          <p className="py-5 text-gray-400 max-w-[70%] m-auto ">
            {" "}
            I'am a self-tought and start my journey for coding at the begining
            of this year. Now I'm focuzing on building responsive front-end web
